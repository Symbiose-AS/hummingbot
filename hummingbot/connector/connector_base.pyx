...
from hummingbot.connector.connector_metrics_collector import (
    ...
    PrometheusTradeVolumeCollector,
)
...
cdef class ConnectorBase(NetworkIterator):
    ...
    def __init__(self, client_config_map: "ClientConfigAdapter"):
        ...
        # Use local Prometheus metrics collector for trade volumes
        self._trade_volume_metric_collector = PrometheusTradeVolumeCollector(
            connector=self,
            activation_interval=Decimal("900"),
